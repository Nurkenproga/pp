...
songs = [
        pygame.mixer.music.load("Music//Tatu_on_your_body.mp3"), 
        pygame.mixer.music.load("Music//ASKING-ALEXANDRIA-The-Black-Official-Music-Video.mp3"),
        pygame.mixer.music.load("Music//Drake-Hotline-Bling-Official-Audio.mp3"), 
        pygame.mixer.music.load("Music//Ne_sebep.mp3"),
        pygame.mixer.music.load("Music//The-Weeknd-Reminder-Audio.mp3"), 
        pygame.mixer.music.load("Music//See-You-Again-Clean-Tyler-The-Creator-Kali-Uchis.mp3"),
        pygame.mixer.music.load("Music//The-Neighbourhood-Sweater-Weather-Lyrics.mp3"),
        pygame.mixer.music.load("Music//New-West-Those-Eyes-Lyrics-sped-up-cause-all-of-the-small-th.mp3")
]
